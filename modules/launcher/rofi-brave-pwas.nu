pkgs: ''
  ...
  def listEntries [] {
    let bookmarks = (open ~/.config/BraveSoftware/Brave-Browser/Default/Bookmarks | from json | get roots | values | where name == 'Bookmarks' | get children | get 0 | where name == 'Progressive Web Apps' | get children | get 0 | each {|it| get_bookmarks_recursive $it} | flatten)
