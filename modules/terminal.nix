{ pkgs, ... }:
let custom-nvim-plugins = import ./neovim/custom-plugins.nix pkgs;
in {
  home-manager.users.christian.programs.kitty = {
    ...
    settings = {
      ...
      "action_alias kitty_scrollback_nvim kitten" =
        "${custom-nvim-plugins.kitty-scrollback-nvim}/python/kitty_scrollback_nvim.py";
